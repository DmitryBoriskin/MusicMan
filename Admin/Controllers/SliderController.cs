...
namespace Admin.Controllers
{
    public class SliderController : CoreController
    {
        ...
        public ActionResult Index(string category, string type)
        {
            ...
            model.List = _cmsRepository.getSlider(filter);
        ...
        {
            model.Item = _cmsRepository.getSlide(Id);
            if (model.Item == null)
        ...
        public ActionResult Item(Guid Id, BannersViewModel bindData, HttpPostedFileBase posted_Image)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                string savePath = Settings.ContentDir + "slider/" + Id + "/";
                if (posted_Image != null && posted_Image.ContentLength > 0)
                {
                    ...
                    if (validExtension.Contains(fileExtension.Replace(".", "")))
                    {
                        ...
                        _File = Imaging.Resize(_File, 1200, 670, "top", "center");
                ...
                bool res = _cmsRepository.creditSlider(bindData.Item, model.Account.id, Request.ServerVariables["REMOTE_ADDR"]);
        ...
        {
            var res = _cmsRepository.deleteSlide(Id);
