...
namespace Admin.Controllers
{
    public class WorksController : CoreController
    {
        ...
        protected override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            #endregion
            #region Метатеги
            ViewBag.Title = "Записи пользователей";
            ViewBag.Description = "";
            ViewBag.KeyWords = "";
            #endregion
        }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (!String.IsNullOrEmpty(bindData.Item.Url))
                {
                    ...
                    else if (bindData.Item.Url.IndexOf("youtube") > -1)
                    {
                        ...
                        bindData.Item.Url = "https://www.youtube.com/embed/" + VideoId;
        ...
        [HttpPost]
        public ActionResult PhotoChangeSort(Guid id, int permit)
        {
            bool Result = false;
        ...
        public string DeletePhoto(string id)
        {
            ...
            if (photo != null)
            {
                string photoPath = photo.Url;
                string previewPath = photo.Preview;
