...
namespace cms.dbModel.entity
{
    public class SettingsModel
    {
        ...
        public bool Disabled { get; set; } // bit
        /// <summary>
        /// Доменное имя для доступа к CMS
        /// </summary>
        [Required(ErrorMessage = "Поле «Домен» не должно быть пустым.")]
        ...
        /// 
        /// </summary>
        public string Contacts { get; set; } // nvarchar(512)
        /// <summary>
        /// Правила использования сайта
        /// </summary>
        public string Regulations { get; set; } // nvarchar(512)
        /// <summary>
        /// Реклама на сайте
        /// </summary>
        public string Advertising { get; set; } // nvarchar(512)
        /// <summary>
        /// Помощь сайту
        /// </summary>
        public string Helping { get; set; } // nvarchar(512)
        /// <summary>
        ...
        public string viber { get; set; } // nvarchar(512)
        public string whatsapp { get; set; } // nvarchar(512)
        public string telegram { get; set; } // nvarchar(512)
        public string skype { get; set; } // nvarchar(512)
        public string vk { get; set; } // nvarchar(512)
        public string facebook { get; set; } // nvarchar(512)
        public string instagram { get; set; } // nvarchar(512)
        public string youtube { get; set; } // nvarchar(512)
    }
}
